...
const FAQS_DATA = [
  { question: "Why Vignette?", answer: "Vignette is a creative platform that transforms ordinary moments into cinematic visual stories. We focus on bespoke pacing and premium color grading." },
  ...
  return (
    <div className={`min-h-screen w-full max-w-full text-zinc-900 dark:text-zinc-100 transition-colors duration-300 relative ${isDark ? 'bg-dark-theme' : 'bg-light-theme'}`}>
      ...
      <main className="relative z-10 w-full overflow-x-hidden">
        ...
        <section id="avgeeks" className="bg-transparent py-20 sm:py-28 scroll-mt-20 overflow-hidden relative min-h-[460px] md:min-h-[480px] flex items-center">
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 relative w-full">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 w-full">
              ...
              <div className="relative z-10 w-full md:w-1/2 flex flex-col items-start text-left">
                <h2 className="reveal font-brand font-bold text-4xl sm:text-5xl md:text-5xl lg:text-6xl tracking-tight leading-[1.1] select-none mb-6">
                ...
                <p className="reveal font-body text-base sm:text-lg text-[#333333] dark:text-zinc-300 max-w-[460px] leading-relaxed transition-colors mb-6 md:mb-10">
                ...
                {/* Mobile Plane (Only visible on screens < 768px, sits between description and button) */}
                <div className="md:hidden w-full my-6 flex justify-center">
                  <img
                    src="b777.png"
                    alt="Boeing 777 Aviation"
                    className="w-[90%] max-w-[340px] h-auto object-contain select-none pointer-events-none hover:scale-[1.03] transition-transform duration-700 ease-out"
                    draggable="false"
                  />
                </div>
              ...
              {/* Absolute Plane Background Overlay (Only visible on screens >= 768px, flys behind text on the right) */}
              <div className="hidden md:block absolute right-[-10%] lg:right-[-5%] top-1/2 -translate-y-1/2 w-[55%] lg:w-[50%] z-[-1] pointer-events-none select-none">
                <div className="reveal reveal-scale w-full h-full">
                  <img
                    src="b777.png"
                    alt="Boeing 777 Aviation"
