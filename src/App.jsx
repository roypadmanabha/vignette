          ...
          >
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center w-full max-w-7xl px-6 lg:px-12 py-4">
              ...
              <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                {/* H1 Heading */}
                <h1 className="reveal font-heading font-black text-hero-fluid tracking-tight leading-[1.1] select-none text-transparent bg-clip-text bg-gradient-to-r from-black to-[#d10000] dark:bg-none dark:text-[#ffec4e] mb-6">
